...
export const DIVISIONS = [
...

  {
    ...
    desc: "NAFDAC-certified processing delivering premium frozen protein — whole birds, cuts, sausages, Belgian fries and Customised Products distributed nationwide.",
    accent: "#187553",
