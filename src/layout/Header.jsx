...
const productCols = [
  {
    ...
    slug: "poultry",
    items: [
      { label: "Parent Stock Day-Old Chicks", to: "/products/poultry/parent-stock" },
      { label: "Commercial Day-Old Chicks", to: "/products/poultry/doc" },
    ],
  },
  {
    heading: "Frozen Meat",
    ...
    items: [
      ...
      { label: "Customised Products", to: "/products/frozen/pizza" },
    ],
  },
  {
    heading: "Aquaculture",
    icon: "🐟",
    slug: "aquaculture",
    items: [{ label: "Catfish", to: "/products/aquaculture/catfish" }],
  },
  {
    heading: "Veterinary",
    icon: "🧬",
    slug: "veterinary",
    items: [
      { label: "Veterinary Services", to: "/products/veterinary/veterinary" },
      { label: "Bio-Security & Lab Diagnostics", to: "/products/veterinary/biosecurity" },
    ],
  },
  {
    ...
    slug: "support",
    items: [
      { label: "Veterinary Services & Customer Support", to: "/products/support/customer-support" },
      { label: "Laboratory Services Support", to: "/products/support/lab-support" },
    ],
  },
  {
    heading: "Equipment",
    ...
    slug: "equipment",
    items: [
      { label: "Big Dutchman", to: "/products/equipment/equipment" },
      { label: "Petersime", to: "/products/equipment/equipment" },
    ],
  },
];
