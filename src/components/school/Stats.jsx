...
const Stats = () => {
  ...
  return (
    <section className="py-12">
      <div
        ref={ref}
        className="grid grid-cols-2 md:grid-cols-4 gap-4 border border-[#1F8F63]/10 rounded-xl overflow-hidden bg-gradient-to-br from-white to-[#d2eee3]/30"
      >
        {stats.map((s, i) => (
          <motion.div
            key={i}
            ...
            className="text-center py-6 px-3 relative group border-b md:border-b-0 md:border-r border-[#1F8F63]/10 last:border-r-0"
          >
            {/* Top accent bar */}
            ...
            {/* Label */}
            <p className="text-[11px] mt-2 text-[#7a9a8a] font-medium">{s.label}</p>
          </motion.div>
        ))}
      </div>
    </section>
