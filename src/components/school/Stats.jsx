...
const Stats = () => {
  ...
  return (
    <section className="py-12">
      <div
        ref={ref}
        className="grid grid-cols-2 md:grid-cols-3 gap-4 border border-primary-500/10 rounded-xl overflow-hidden bg-gradient-to-br from-white to-[#d2eee3]/30"
      >
        {stats.map((s, i) => (
          <motion.div
            key={i}
          ...
          >
            ...
            {/* Label */}
            <p className="text-[11px] mt-2 text-dark-400 font-medium">
              {s.label}
            </p>
          </motion.div>
        ))}
