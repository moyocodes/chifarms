...
function DivisionCard({ d, index }) {
  ...
  const previewImage = d.categories?.[0]?.items?.[0]?.image || d.categories?.[0]?.image || null;
        ...
        >
          ...
          <div style={{ marginBottom: "3.5rem" }}>
            ...
            >
              ...
              >
                At Chi Farms Limited, we are committed to delivering quality and innovation across every step of the food and agricultural value chain. Our diverse product offerings are designed to meet the growing needs of consumers, businesses, and partners across Nigeria and beyond.
<br/>
                ...
                >
                Explore our key product categories below:
                </span>
              </motion.p>
            </div>
