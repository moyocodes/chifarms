  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        <img
          src="https://res.cloudinary.com/drxxei318/image/upload/q_auto/f_auto/v1777936350/WhatsApp_Image_2026-05-05_at_00.09.24_1_paq3cs.jpg"
          alt="Contact"
          style={{
            width: "100%",
            height: "100%",
          ...
          >
            ...
            >
              <div>
                ...
                <div
                  style={{ fontWeight: 700, color: "#ffffff", fontSize: 14 }}
                >
                  info@chifarms.com
                </div>
              </div>
