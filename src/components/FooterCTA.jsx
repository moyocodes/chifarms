      ...
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(circle, rgba(31,143,99,0.07) 0%, transparent 65%)",
            filter: "blur(80px)",
          }}
        />
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(circle, rgba(65,170,128,0.06) 0%, transparent 65%)",
            filter: "blur(60px)",
          }}
        />
        ...
        <div
          style={{
            ...
            opacity: 0.32,
            backgroundImage:
              "radial-gradient(circle, rgba(31,143,99,0.18) 1px, transparent 1px)",
        ...
        >
          <div className="cta-grid">
            ...
            >
              ...
              >
                Join thousands of farmers who trust Chi Farms for quality
                chicks, nutrition, and expert technical support.
              </p>
              ...
              <div className="quick-dial-grid">
                {phones.map((p, i) => (
                  <motion.a
                    ...
                    whileHover={{
                      background: "rgba(31,143,99,0.07)",
                      borderColor: "rgba(31,143,99,0.22)",
                    }}
                    style={{
                      padding: "9px 11px",
                      borderRadius: 10,
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 20,
                  background:
                    "linear-gradient(145deg, #1F8F63 0%, #0f5c3a 100%)",
                  boxShadow:
                    "0 20px 60px rgba(31,143,99,0.22), 0 1px 0 rgba(255,255,255,0.1) inset",
                  position: "relative",
                  overflow: "hidden",
                }}
              >
