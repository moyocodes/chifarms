...
const DIVISION_IMAGES = {
  ...
  frozen:
    "https://res.cloudinary.com/drxxei318/image/upload/q_auto/f_auto/v1777933949/froze_roq2gg.jpg",
  aquaculture:
    "https://res.cloudinary.com/drxxei318/image/upload/q_auto/f_auto/v1777933981/fish_zrtrwb.jpg",
  veterinary:
...
export default function Hero() {
  ...
  useEffect(() => {
    if (paused) return;
    const t = setInterval(
      () => setIndex((p) => (p + 1) % DIVISIONS.length),
      5000,
    );
          ...
          >
            <motion.div
              animate={{
                width: i === index ? 36 : 8,
                background:
                  i === index ? colors.primaryLight : "rgba(255,255,255,0.35)",
              }}
