...
export default function HeroBanner({ d, activeCat, logoSrc, breadcrumbs }) {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { size: 460, top: "-90px", right: "-95px", opacity: 0.035 },
          { size: 270, bottom: "-55px", left: "-70px", opacity: 0.035 },
          { size: 180, top: "28%", right: "25%", opacity: 0.11 },
        ].map((pos, i) => (
          <div
            key={i}
            style={{
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        <motion.p
          {...fadeUp(0.3)}
          className="text-primary-600 text-xs font-normal  tracking-wider mt-2"
        >
          {activeCat ? activeCat.summary : d.summary}
        </motion.p>
